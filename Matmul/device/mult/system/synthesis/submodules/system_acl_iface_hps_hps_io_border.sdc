...
set_false_path -from [get_ports hps_io_hps_io_gpio_inst_GPIO55] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_gpio_inst_GPIO55]
set_false_path -from [get_ports hps_io_hps_io_gpio_inst_GPIO56] -to *
set_false_path -from * -to [get_ports hps_io_hps_io_gpio_inst_GPIO56]